  ...
  checkDomainName = domainName => {
    ...
    if (domainName !== "") {
      ...
      if (this.state.domainName === "wcloud.vn") {
        url =
          "https://" + this.state.domainName + "/web/webclient/version_info";
      } else {
      ...
      fetch(url, {
        ...
        .then(responseJson => {
          ...
          AsyncStorage.setItem(
            "company_domain",
            this.state.domainName.toLowerCase().trim()
          );
      ...
      <View style={styles.wrapper}>
        <View style={styles.wrapperContainer}>
          ...
          <View style={{ justiftyContent: "center", alignItems: "center" }}>
            <Icon name="rocket" size={120} color="#900" />
            <Text>启源建材ERP系统</Text>
          </View>
          ...
          <Form style={styles.formWrapper}>
            ...
            {this.state.domainNameError && (
              <Text style={styles.errorLabel}>
                Your company domain not valid or you do not have wcloud account
                yet. Please contact support for assistant
              </Text>
            )}
          </Form>
        </View>
